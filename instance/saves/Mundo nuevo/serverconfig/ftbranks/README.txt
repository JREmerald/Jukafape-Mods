...
Last README file update: Sun Aug 25 19:13:05 ART 2024
...
command.npc
command.npc.action
command.npc.action.goto
command.npc.action.goto.block pos
command.npc.action.interact
command.npc.action.interact.block pos
command.npc.create
command.npc.create.name
command.npc.deselect
command.npc.edit
command.npc.edit.behaviour
command.npc.edit.behaviour.behaviour
command.npc.edit.commands
command.npc.edit.commands.add
command.npc.edit.commands.addBungee
command.npc.edit.commands.addBungee.command
command.npc.edit.commands.addBungee.command.player
command.npc.edit.commands.addBungee.command.player.argument
command.npc.edit.commands.clear
command.npc.edit.commands.cooldown
command.npc.edit.commands.cooldown.editMessage
command.npc.edit.commands.cooldown.editMessage.new cooldown message
command.npc.edit.commands.cooldown.set
command.npc.edit.commands.cooldown.set.cooldown
command.npc.edit.commands.list
command.npc.edit.commands.remove
command.npc.edit.commands.remove.command id
command.npc.edit.commands.setPermissionLevel
command.npc.edit.commands.setPermissionLevel.level
command.npc.edit.equipment
command.npc.edit.equipment.allowEquipmentDrops
command.npc.edit.equipment.allowEquipmentDrops.drop
command.npc.edit.look
command.npc.edit.messages
command.npc.edit.messages.clear
command.npc.edit.messages.list
command.npc.edit.messages.message id
command.npc.edit.messages.message id.delete
command.npc.edit.messages.message id.setDelay
command.npc.edit.messages.message id.setDelay.delay
command.npc.edit.messages.swap
command.npc.edit.messages.swap.id 1
command.npc.edit.messages.swap.id 1.id 2
command.npc.edit.mount
command.npc.edit.mount.entity
command.npc.edit.movement
command.npc.edit.movement.allowFlight
command.npc.edit.movement.allowFlight.allowFlight
command.npc.edit.movement.follow
command.npc.edit.movement.follow.follow type
command.npc.edit.movement.follow.follow type.uuid
command.npc.edit.movement.movement type
command.npc.edit.name
command.npc.edit.name.new name
command.npc.edit.path
command.npc.edit.path.clear
command.npc.edit.pose
command.npc.edit.pose.pose name
command.npc.edit.professions
command.npc.edit.professions.add
command.npc.edit.professions.add.profession type
command.npc.edit.professions.list
command.npc.edit.professions.remove
command.npc.edit.professions.remove.profession type
command.npc.edit.respawn
command.npc.edit.respawn.setCoordinates
command.npc.edit.respawn.setCoordinates.coordinates
command.npc.edit.respawn.toggle
command.npc.edit.respawn.toggle.do respawn
command.npc.edit.skin
command.npc.edit.skin.mineskin URL | playername
command.npc.edit.tags
command.npc.edit.tags.allowEquipmentDrops
command.npc.edit.tags.allowEquipmentDrops.drop
command.npc.edit.tags.allowRiding
command.npc.edit.tags.allowRiding.allowRiding
command.npc.edit.tags.allowSounds
command.npc.edit.tags.allowSounds.allow sounds
command.npc.edit.tags.allowSwimming
command.npc.edit.tags.allowSwimming.allow swim
command.npc.edit.tags.jumpWhileAttacking
command.npc.edit.tags.jumpWhileAttacking.perform jumps
command.npc.edit.tags.leashable
command.npc.edit.tags.leashable.leashable
command.npc.edit.tags.pushable
command.npc.edit.tags.pushable.pushable
command.npc.edit.tags.showCustomName
command.npc.edit.tags.showCustomName.show custom name
command.npc.edit.tags.sneakNameType
command.npc.edit.tags.sneakNameType.sneak type name
command.npc.edit.type
command.npc.edit.type.entity type
command.npc.edit.type.entity type.nbt
command.npc.edit.type.minecraft:player
command.npc.edit.type.player
command.npc.edit.type.reset
command.npc.list
command.npc.lock
command.npc.preset
command.npc.preset.load
command.npc.preset.load.preset name
command.npc.preset.save
command.npc.preset.save.preset name
command.npc.remove
command.npc.select
command.npc.select.id
command.npc.tp
command.npc.tp.entity
command.npc.tp.location
command.npc.unlock
command.numismatic
...
command.profession
command.profession.scarpetTraits
command.profession.scarpetTraits.add
command.profession.scarpetTraits.add.id
command.profession.scarpetTraits.list
command.profession.scarpetTraits.remove
command.profession.scarpetTraits.remove.id
command.publish
...
command.taterzens
command.taterzens.config
command.taterzens.config.edit
command.taterzens.config.edit.bungee
command.taterzens.config.edit.bungee.enableCommands
command.taterzens.config.edit.bungee.enableCommands.value
command.taterzens.config.edit.combatInPeaceful
command.taterzens.config.edit.combatInPeaceful.value
command.taterzens.config.edit.defaults
command.taterzens.config.edit.defaults.allowFlight
command.taterzens.config.edit.defaults.allowFlight.value
command.taterzens.config.edit.defaults.allowRiding
command.taterzens.config.edit.defaults.allowRiding.value
command.taterzens.config.edit.defaults.allowSwim
command.taterzens.config.edit.defaults.allowSwim.value
command.taterzens.config.edit.defaults.ambientSounds
command.taterzens.config.edit.defaults.ambientSounds.value
command.taterzens.config.edit.defaults.commandCooldownMessage
command.taterzens.config.edit.defaults.commandCooldownMessage.value
command.taterzens.config.edit.defaults.commandPermissionLevel
command.taterzens.config.edit.defaults.commandPermissionLevel.value
command.taterzens.config.edit.defaults.deathSounds
command.taterzens.config.edit.defaults.deathSounds.value
command.taterzens.config.edit.defaults.hurtSounds
command.taterzens.config.edit.defaults.hurtSounds.value
command.taterzens.config.edit.defaults.invulnerable
command.taterzens.config.edit.defaults.invulnerable.value
command.taterzens.config.edit.defaults.jumpWhileAttacking
command.taterzens.config.edit.defaults.jumpWhileAttacking.value
command.taterzens.config.edit.defaults.leashable
command.taterzens.config.edit.defaults.leashable.value
command.taterzens.config.edit.defaults.minInteractionTime
command.taterzens.config.edit.defaults.minInteractionTime.value
command.taterzens.config.edit.defaults.name
command.taterzens.config.edit.defaults.name.value
command.taterzens.config.edit.defaults.pushable
command.taterzens.config.edit.defaults.pushable.value
command.taterzens.config.edit.disableRegistrySync
command.taterzens.config.edit.disableRegistrySync.value
command.taterzens.config.edit.fabricTailorAdvert
command.taterzens.config.edit.fabricTailorAdvert.value
command.taterzens.config.edit.guiItemModelData
command.taterzens.config.edit.guiItemModelData.value
command.taterzens.config.edit.hideOpsMessage
command.taterzens.config.edit.hideOpsMessage.value
command.taterzens.config.edit.language
command.taterzens.config.edit.language.language
command.taterzens.config.edit.lockAfterCreation
command.taterzens.config.edit.lockAfterCreation.value
command.taterzens.config.edit.messages
command.taterzens.config.edit.messages.exitEditorAfterMsgEdit
command.taterzens.config.edit.messages.exitEditorAfterMsgEdit.value
command.taterzens.config.edit.messages.messageDelay
command.taterzens.config.edit.messages.messageDelay.value
command.taterzens.config.edit.messages.speakDistance
command.taterzens.config.edit.messages.speakDistance.value
command.taterzens.config.edit.messages.structure
command.taterzens.config.edit.messages.structure.value
command.taterzens.config.edit.path
command.taterzens.config.edit.path.color
command.taterzens.config.edit.path.color.blue
command.taterzens.config.edit.path.color.blue.value
command.taterzens.config.edit.path.color.green
command.taterzens.config.edit.path.color.green.value
command.taterzens.config.edit.path.color.red
command.taterzens.config.edit.path.color.red.value
command.taterzens.config.edit.perms
command.taterzens.config.edit.perms.allowSettingHigherPermissionLevel
command.taterzens.config.edit.perms.allowSettingHigherPermissionLevel.value
command.taterzens.config.edit.perms.npcCommandPermissionLevel
command.taterzens.config.edit.perms.npcCommandPermissionLevel.value
command.taterzens.config.edit.perms.professionCommandPL
command.taterzens.config.edit.perms.professionCommandPL.value
command.taterzens.config.edit.perms.savePermsFile
command.taterzens.config.edit.perms.savePermsFile.value
command.taterzens.config.edit.perms.selectBypassLevel
command.taterzens.config.edit.perms.selectBypassLevel.value
command.taterzens.config.edit.perms.taterzensCommandPermissionLevel
command.taterzens.config.edit.perms.taterzensCommandPermissionLevel.value
command.taterzens.config.edit.prefersExecution
command.taterzens.config.edit.prefersExecution.value
command.taterzens.config.edit.taterzenTablistTimeout
command.taterzens.config.edit.taterzenTablistTimeout.value
command.taterzens.config.reload
command.taterzens.wiki
command.team
command.team.add
